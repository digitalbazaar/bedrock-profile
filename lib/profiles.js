 ...
 */
exports.create = async ({account, settings}) => {
 ...
 *
 * @param {Object} account the account associated with the Profile.
 * @param {Object} profileId the id associated with the Profile.
 *
 * @return {Promise<Profile>} resolves to a profile's settings.
 */
exports.get = async ({account, profileId}) => {
 ...
 *
 * @param {Object} account the account associated with the Profile(s).
 *
