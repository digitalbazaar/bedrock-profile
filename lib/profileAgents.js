...
exports.create = async ({
  kmsMeterCapability, accountId, profileId, token
} = {}) => {
  ...
  // FIXME: the KMS plugin used will need to be specified and the same
  // one will be used for profile agent + profile if a profile is being
  // created
  ...
  const secret = base64url.encode(await randomBytesAsync(32));
