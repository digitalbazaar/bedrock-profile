...
// "long-lived" zcaps should not be configured to auto-refresh more quickly
// than 15 minutes as this creates an unnecessary burden on the system
...
async function _refreshZcaps({record}) {
  ...
  while(true) {
    ...
    const newRecord = klona({...record, secrets: undefined});
