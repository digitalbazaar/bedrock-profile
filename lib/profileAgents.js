...
bedrock.events.on('bedrock-mongodb.ready', async () => {
  ...
  await database.createIndexes([{
    ...
    // FIXME: enforce uniqueness differently
    // FIXME: implies need for a `profileAgentController` collection that
    // maps controller to profileAgentId
    collection: 'profile-profileAgent',
    ...
    // FIXME: enforce uniqueness differently
    // FIXME: implies need for a `profileAgentAccount` collection that
    // maps accountId to profileAgentId
    collection: 'profile-profileAgent',
    ...
    // FIXME: ensure duplicate concurrent / repeated calls to add a
    // profile agent could not produce more than one record
    collection: 'profile-profileAgent',
