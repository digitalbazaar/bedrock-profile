 ...
 * @param {object} [didMethodOptions] - Hashmap of optional DID method options.
 * @param {string} [didMethodOptions.method] - Supported: 'key' and 'v1'.
 *
 * @return {Promise<Object>} resolves to a ProfileAgent.
 */
exports.create = async ({
  accountId, profileId, token, didMethodOptions} = {}) => {
  ...
  key.id = await utils.computeKeyId({key, ...didMethodOptions});
 ...
 * @param {boolean} [includeSecrets=false] - Include secrets in the result.
 *
 ...
 *   ProfileAgent(s).
 * @param {boolean} [includeSecrets=false] - Include secrets in the results.
 *
 * @return {Promise<Array<Object>>} resolves to a ProfileAgent record(s).
 */
